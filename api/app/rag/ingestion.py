...
def get_knowledge_base_dir() -> str:
    candidates = [
        ...
        os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "data", "knowledge_base")),
        os.path.abspath(os.path.join(os.path.dirname(__file__), "data", "knowledge_base")),
        os.path.abspath("./data/knowledge_base"),
        os.path.abspath("./api/data/knowledge_base"),
        os.path.abspath("/var/task/data/knowledge_base"),
        os.path.abspath("/var/task/api/data/knowledge_base"),
    ]
    for c in candidates:
